...
<body>
    ...
    <script>
        $(document).ready(function(){
            ...
            $('#list').DataTable({
                columnDefs: [
                    { orderable: false, targets: [5] } // Kolom 'Action' tidak dapat diurutkan
                ],
                order:[0,'asc'],
                autoWidth: false,
                responsive: true,
                ...
                lengthChange: true, // Mengaktifkan dropdown untuk mengubah jumlah baris yang ditampilkan
                info: true // Menampilkan informasi tambahan seperti jumlah baris total
            });
